       ...
       <p >Questions </p>
          <input type="email" class="form-control  ml-2 pt-2 " style="border:solid 1px #3addd6; height: 80px; width:450px;margin-top:10px;" id="exampleInputEmail1" aria-describedby="emailHelp">
              ...
              <div style="display: flex;margin-bottom: 20px;">
               ...
               <img src="<?=URL_ASSETS?>/img/ic-ajout-réponse.png" height="40px" width="40px" style="margin-top: 10px;">
              </div>
              <div style="display: flex;margin-bottom: 20px;">
                <p>Reponse 1 </p>
                ...
                <img src="<?=URL_ASSETS?>/img/ic-supprimer.png" width="20px" height="20px" style="margin: 21px 0px 0px 6px;">
              </div>
