...
<html lang="en">
  ...
  <body>
      ...
      <img src="<?=URL_ASSETS?>/img/logo-QuizzSA.png" class="img-fluid" style="height:100px; margin-right: 500px;"> 
      <p class="text-center" style="align-items: center;color: #f8fdfd;font-size: 40px;">Le plaisir de jouer</p>
         
      </nav>
      <style> 
      body{
        background:url('<?=URL_ASSETS?>/img/img-bg.jpg') ;
...
margin-left: 10px;
    ...
    <a name="c" type="submit" class="btn col-2 ml-5 pt-2" href="connexion.php" style=" width:200px; background-color:#3addd6 ; color: #f8fdfd;margin: 10px 7px 0px 0px" role="button">Deconnexion</a>
      </div>
        ...
        <div class="container left" style="width: 400px; height: 450px;border-radius: 10px; border: solid #818181 1px;margin: 55px 30px 0px -12px;">
           <div style="height: 150px;background-color:#3addd6 ;width: 398px;margin: 0px 7px 0px -15px ;padding-left: 20px;padding-top: 7px;border-radius: 10px;">
            ...
            <div class="left-deux" style="margin: 9px 0px 0px 8px;">
                <img src="<?=URL_ASSETS?>/img/avatar.png" class="rounded-circle" style="border:solid white 1px ;height: 100px; width: 100px; ;">
           ...
           <div class="left-trois" style="margin: 13px 0px 0px -3px;">
            ...
            <img src="<?=URL_ASSETS?>/img/ic-liste-active.png" style=" margin: -107px -18px -26px 323px;height: 25px;width: 25px;">
            </div>
            <div style="height: 60px; width: auto; border: solid white 3px; display: flex; flex-direction: column;">
                ...
                <img src="<?=URL_ASSETS?>/img/ic-ajout.png" style=" margin: -43px -18px -26px 323px;height: 25px;width: 25px;">
            </div>
            <div style="height: 60px; width: auto; border: solid white 3px;">

                <p style="font-size: 22px;">Liste Joueurs</p>
                <img src="<?=URL_ASSETS?>/img/ic-liste.png" style=" margin: -90px -18px -26px 323px;height: 25px;width: 25px;">
            </div>
            <div style="height:60px; width:auto; border: solid white 3px;">
                <p style="font-size: 22px;">Créer Questions</p>
                <img src="<?=URL_ASSETS?>/img/ic-ajout.png" style=" margin: -90px -18px -26px 323px;height: 25px;width: 25px;">
            </div>
           </div>
        </div>
