...

{
     ...
     if($quest[$j]->getType()=="cm"){
      ...
      echo '</div>
        ...
        <input type="checkbox" name="fichier" id="check1" >
      ...
      echo '</div>
        ...
        <div>
          ...
          <div>
            ...
            <input type="button"  value="Précédent" class="btn pt-2" id="Précédent" style=" font-family: bold;width:100px;height:50px ; background-color:#3addd6 ; color: #f8fdfd;margin: 21px 0px 0px 0px" onClick="document.location.href='<?=WEBROOT?>/jeu/intJoueur/<?=$pageActuelle-1?>'" />
            <script>
                var btn = document.getElementById('Précédent');
            ...
            if($pageActuelle!=5){
              ...
              ?>
            <input type="button"  value="Suivant" class="btn pt-2" id="Suivant" style=" font-family: bold;width:100px;height:50px ; background-color:#3addd6 ; color: #f8fdfd;margin: -102px 7px 0px 458px" onClick="document.location.href='<?=WEBROOT?>/jeu/intJoueur/<?=$pageActuelle+1?>'" />
            <script>
